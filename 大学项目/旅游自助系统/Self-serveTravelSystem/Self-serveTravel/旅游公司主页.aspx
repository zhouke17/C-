<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="旅游公司主页.aspx.cs" Inherits="Self_serveTravelSystem.Self_serveTravel.旅游公司主页" %>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				<%--<li class="scroll hvr-underline-from-center"><a href="上传.aspx">上传</a></li>--%>
          	<li><a class="scroll hvr-underline-from-center" href="审核.aspx">审核</a></li>
